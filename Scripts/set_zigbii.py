...
leave = b'leave\r' 
form = b'form "747070536D617276"\r'
query = b'query_neighbor\r'

network = ('11', '0x1900') #Параметры целевой сети
EUI_dev = 'EC64A7FEFF8D79E0' #'21841F16006F0D00'
...
def scaning_zigbee():
    ...
    channel_set_config(ser, network)
    set_coordination(ser)

    n = 0
    while True:
        FIND_DEV_NET = finding_device(ser, network)
        n+=1
